...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <p><b style="color: #6666ff">Difficulty: </b> <?php echo $recipe['difficulty'] ?></p>

            <p><b style="color: #6666ff">Cooking time: </b> <?php echo $recipe['cooking_time'] ?> minute(s)</p>

            <p><b style="color: #6666ff">Servings: </b> <?php echo $recipe['serving'] ?></p>
        ...
        <div class="col-lg-6">
            ...
            if ($recipe['youtube'] == null || $recipe['youtube'] == "null") {
                ...
                echo '<a style="text-decoration: none; font-size: 1.2em;" href="' . $recipe['youtube'] . '" target="_blank"><i style="color: red;" class="fab fa-youtube"></i>&nbspClick here for a YouTube Tutorial</a><br><br>';
            }
            ?>
            ...
            <div class="comment_section">
                ...
                <br>
                <p id="rate_sign">Rate this Recipe:</p>
                <div class="stars">
        ...
        <div class="col-lg-2">
            <?php
            $table = "<table id='ing_table'><tr><th id='mid1'>Ingredent</th><th id='mid'>Amount</th><th id='mid'>Unit</th></tr>";
